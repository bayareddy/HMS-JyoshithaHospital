...
export function Patients({ patients }: { patients: Patient[] }) {
  ...
  return (
    <div className="bg-surface border border-border-subtle rounded-xl overflow-hidden">
      <div className="flex gap-2 p-2.5 px-4 border-b border-border-subtle items-center flex-wrap">
        ...
        <table className="w-full text-left text-[12px] border-collapse">
          <thead>
            <tr className="bg-surface2 border-b border-border-subtle">
              ...
              <th className="py-2.5 px-3.5 font-medium text-[11px] text-gray-500">Age / Gender</th>
              ...
              <th className="py-2.5 px-3.5 font-medium text-[11px] text-gray-500">Diagnosis</th>
              <th className="py-2.5 px-3.5 font-medium text-[11px] text-gray-500">Blood Group</th>
              <th className="py-2.5 px-3.5 font-medium text-[11px] text-gray-500">Status</th>
              <th className="py-2.5 px-3.5 font-medium text-[11px] text-gray-500">Admitted</th>
            </tr>
          </thead>
          <tbody>
            {filteredPatients.map((p, i) => (
              <tr key={i} className="border-b border-border-subtle last:border-0 hover:bg-[#fafaf9]">
                ...
                <td className="py-2.5 px-3.5">{p.age} / {p.gender}</td>
                <td className="py-2.5 px-3.5">{p.ward}</td>
                <td className="py-2.5 px-3.5">{p.doctor}</td>
                <td className="py-2.5 px-3.5">{p.diagnosis}</td>
                <td className="py-2.5 px-3.5">{p.blood}</td>
                <td className="py-2.5 px-3.5">
